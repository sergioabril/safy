...
class OvalLayer: CAShapeLayer {
  ...
  var ovalPathLarge: UIBezierPath {
    return UIBezierPath(ovalIn: CGRect(x: 2.5, y: 17.5, width: 40.0, height: 40.0))
  }
  
  var ovalPathSquishVertical: UIBezierPath {
    return UIBezierPath(ovalIn: CGRect(x: 2.5, y: 20.0, width: 40.0, height: 35.0))
  }
  
  var ovalPathSquishHorizontal: UIBezierPath {
    return UIBezierPath(ovalIn: CGRect(x: 5.0, y: 20.0, width: 35.0, height: 40.0))
  }
